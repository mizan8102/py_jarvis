...
__all__ = [
    'DISPID_SRCCreateResultFromMemory', 'DISPID_SpeechMemoryStream',
    'ISpNotifyTranslator', 'ISpeechLexiconPronunciation',
    'DISPID_SRGetPropertyString', 'SPINTERFERENCE_TOOLOUD',
    'DISPID_SPIGetText', 'DISPID_SAFGuid', 'DISPID_SGRSTNextState',
    'SPBO_NONE', 'DISPID_SPACommit', 'SpeechTokenKeyAttributes',
    'DISPID_SpeechBaseStream', 'IInternetSecurityManager',
    'DISPID_SPRNumberOfElements', 'SAFT44kHz8BitStereo',
    'DISPID_SRCCreateGrammar', 'SWTAdded', 'DISPID_SLPsItem',
    'SPEVENTENUM', 'DISPID_SPIRule', 'DISPID_SVPause',
    'DISPID_SASFreeBufferSpace', 'SPWORDPRONUNCIATIONLIST',
    'DISPID_SPISaveToMemory', 'ISpRecoGrammar2',
    'DISPID_SVIsUISupported', 'SSFMOpenReadWrite',
    'SpeechVoiceCategoryTTSRate', 'SRERecoOtherContext',
    'DISPID_SASetState', 'SAFT11kHz16BitMono', 'SFTInput',
    'DISPID_SRSClsidEngine', 'DISPID_SLWPronunciations',
    'DISPID_SRCERequestUI', 'SPDATAKEYLOCATION', 'SpeechVoiceEvents',
    'SVEVoiceChange', 'SRTSMLTimeout',
    'DISPID_SASCurrentSeekPosition', 'DISPID_SRSetPropertyString',
    'SDTDisplayText', 'DISPID_SPIRetainedSizeBytes',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'SPEI_SR_RETAINEDAUDIO',
    'DISPID_SLGetPronunciations', 'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001',
    'DISPID_SRCreateRecoContext', 'SSTTWildcard', 'SP_VISEME_0',
    'ISpPhraseAlt', 'SDKLCurrentConfig', 'SAFT22kHz16BitStereo',
    'DISPID_SRCVoicePurgeEvent', 'DISPID_SRCEFalseRecognition',
    'DISPID_SpeechRecognizerStatus', 'SVP_13',
    'DISPID_SRCEAudioLevel', 'SAFT16kHz8BitStereo', 'SPCONTEXTSTATE',
    'SAFTGSM610_8kHzMono', 'SP_VISEME_11', 'DISPID_SPIProperties',
    'DISPID_SpeechGrammarRuleStateTransition', 'SPPS_NotOverriden',
    'DISPID_SpeechGrammarRuleState', 'DISPID_SVAudioOutput',
    'DISPID_SPRules_NewEnum', 'DISPID_SpeechPhraseBuilder',
    'SpMemoryStream', 'Speech_Default_Weight', 'DISPID_SPEs_NewEnum',
    'DISPID_SVWaitUntilDone', 'DISPID_SPEAudioSizeBytes',
    'SPEI_END_INPUT_STREAM', 'SAFT8kHz8BitStereo',
    'SAFT11kHz8BitMono', 'ISpeechFileStream', 'SPSModifier',
    'DISPID_SRCRequestedUIType', 'SPWT_LEXICAL_NO_SPECIAL_CHARS',
    'DISPID_SPPValue', 'SGRSTTRule',
    'DISPID_SRCEPropertyNumberChange', 'ISpStreamFormat',
    'DISPID_SRCEHypothesis', '_ISpeechVoiceEvents', 'SPPS_Verb',
    'SPCATEGORYTYPE', 'DISPID_SPIEngineId', 'SGLexical',
    'DISPID_SRGRecoContext', 'DISPID_SAStatus',
    'SpeechAudioProperties', 'SECFNoSpecialChars', 'SpeechTokenKeyUI',
    'SITooLoud', 'SPPS_Interjection', 'SPWORDPRONUNCIATION',
    'DISPID_SpeechRecoResultTimes', 'DISPID_SRGRules', 'DISPIDSPRG',
    'DISPID_SASState', 'DISPID_SAFType', 'DISPID_SVSInputWordLength',
    'DISPID_SVEEnginePrivate', 'DISPID_SPIStartTime',
    'DISPID_SRRTimes', 'DISPID_SRGetFormat', 'SRSActive',
    'DISPID_SpeechFileStream', 'SAFT24kHz8BitStereo',
    'DISPID_SLAddPronunciationByPhoneIds', 'SSSPTRelativeToStart',
    'DISPID_SVSPhonemeId', 'SP_VISEME_3', 'DISPID_SOTGetDescription',
    'DISPID_SVPriority', 'DISPID_SGRSTText', 'SVESentenceBoundary',
    'SpeechDisplayAttributes',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet', 'SVP_6',
    'WAVEFORMATEX', 'SVPAlert', 'DISPID_SDKSetStringValue',
    'DISPID_SRRGetXMLErrorInfo', 'DISPID_SAEventHandle',
    'DISPID_SpeechVoiceStatus', 'DISPID_SRRSetTextFeedback',
    'SAFTADPCM_44kHzStereo', 'DISPID_SRCEStartStream',
    'ISpPhoneticAlphabetSelection',
    'ISpeechGrammarRuleStateTransitions', 'LONG_PTR', 'SREAdaptation',
    'DISPID_SABufferInfo', 'DISPID_SpeechPhraseAlternate',
    'DISPID_SRState', 'SECFIgnoreWidth', 'SPSHT_Unknown',
    'tagSPTEXTSELECTIONINFO', 'SPFM_OPEN_READONLY',
    'DISPID_SOTIsUISupported', 'DISPID_SRGCommit', 'SVPOver',
    'SPEI_PHRASE_START', 'SAFTCCITT_ALaw_44kHzStereo',
    ...
    'SpeechRegistryUserRoot', 'SpStream', 'DISPID_SpeechObjectToken',
    'SPGS_EXCLUSIVE', 'SPBO_PAUSE', 'DISPID_SRRAudioFormat',
    'ISpeechRecoGrammar', 'SPPROPERTYINFO', 'SPSNoun',
    'SPFM_NUM_MODES', 'SpeechAddRemoveWord', 'SREFalseRecognition',
    'SPEI_HYPOTHESIS', 'SRCS_Enabled', 'SpeechRuleState',
    'SPVPRI_NORMAL', 'SPEI_END_SR_STREAM', 'SPEI_MAX_SR',
    'DISPID_SRRGetXMLResult', 'SAFTNoAssignedFormat',
    'SPAUDIOOPTIONS', 'SREStateChange', 'DISPID_SGRSTWeight',
    'SSSPTRelativeToCurrentPosition', 'ISpXMLRecoResult',
    'SPAUDIOBUFFERINFO', 'STCRemoteServer', 'SLTApp',
    'DISPID_SVSLastBookmark', 'DISPID_SRStatus', 'ISpeechVoice',
    'SPSLMA', 'SPEI_INTERFERENCE', 'SPEI_RESERVED6',
    'DISPID_SMSGetData', 'SPGRAMMARWORDTYPE', 'SPWT_LEXICAL',
    'SPSVerb', 'DISPID_SGRSAddRuleTransition', 'SpPhoneConverter',
    'SPWORD', 'DISPID_SRIsShared', 'SpShortcut', 'DISPID_SBSRead',
    'SPSHT_EMAIL', 'SpeechVoicePriority',
    'DISPID_SOTCEnumerateTokens', 'DISPID_SPAsCount',
    'DISPID_SpeechPhraseRule', 'SAFTADPCM_22kHzStereo',
    'ISpeechTextSelectionInformation', 'ISpeechLexiconWord',
    'STCInprocServer', 'DISPID_SpeechAudioFormat',
    'DISPID_SPILanguageId', 'eLEXTYPE_RESERVED8',
    'DISPID_SOTCDefault', 'SPPS_RESERVED2', 'SPPS_RESERVED3',
    'SREStreamStart', 'DISPID_SPRuleChildren', 'SDTProperty',
    'SPCS_ENABLED', 'tagSTATSTG', 'SVEAudioLevel', 'SPRST_INACTIVE',
    'DISPID_SRSCurrentStreamPosition', 'SAFT8kHz16BitStereo',
    'SPPS_Unknown', 'DISPID_SGRSRule', 'SVF_Emphasis', 'SREAllEvents',
    'SpeechDictationTopicSpelling', 'SREStreamEnd', 'SAFTText',
    'DISPID_SFSClose', 'ISpeechCustomStream', 'SVF_Stressed',
    'SpeechMicTraining', 'DISPID_SVSInputWordPosition', 'SVEViseme',
    'SECNormalConfidence', 'SREAudioLevel', 'eLEXTYPE_PRIVATE17',
    'SSSPTRelativeToEnd', 'DISPID_SPEDisplayAttributes',
    'SAFTGSM610_22kHzMono', 'SAFT32kHz8BitStereo',
    'SSFMCreateForWrite', 'SpeechCategoryAppLexicons',
    'DISPID_SRCState', 'ISpeechPhraseRules',
    'DISPID_SRGCmdLoadFromResource', 'DISPID_SPEEngineConfidence',
    'DISPID_SPRuleEngineConfidence', 'SpeechEmulationCompareFlags',
    'SPEI_TTS_PRIVATE', 'ISpeechAudioStatus', 'SVP_17',
    'DISPID_SGRsFindRule', 'SPEI_VISEME', 'SpAudioFormat',
    'DISPID_SAFGetWaveFormatEx', 'SPINTERFERENCE_NONE', 'SP_VISEME_4',
    'SPSHT_NotOverriden', 'SAFT32kHz16BitStereo',
    'SPEI_PROPERTY_STRING_CHANGE', 'STCInprocHandler', 'SPPS_Noun',
    'SVEWordBoundary', '_RemotableHandle',
    'DISPID_SRGSetTextSelection', 'SRAInterpreter', 'SVSFVoiceMask',
    'Speech_StreamPos_RealTime', 'DISPID_SPRuleConfidence',
    'DISPID_SAFSetWaveFormatEx', 'DISPID_SVSLastBookmarkId',
    'DISPID_SPPId', 'DISPID_SpeechVoiceEvent', 'SPWT_DISPLAY',
    'DISPID_SREmulateRecognition', 'SRERecognition',
    'DISPID_SRGIsPronounceable', 'DISPID_SRGCmdLoadFromMemory',
    'DISPID_SOTSetId', 'DISPID_SPPBRestorePhraseFromMemory',
    'SPSSuppressWord', 'ISpEventSource', 'DISPID_SOTs_NewEnum',
    'SP_VISEME_15', 'DISPID_SPRuleFirstElement', 'SVSFlagsAsync',
    'DISPID_SVResume', 'DISPID_SPRsCount', 'ISpeechPhraseProperties',
    'SRSEDone', 'SPEVENTSOURCEINFO', 'SPRST_ACTIVE', 'SASPause',
    'ISpPhoneConverter', 'SAFTADPCM_44kHzMono',
    'DISPID_SRCEInterference', 'SPAS_CLOSED',
    'SAFTExtendedAudioFormat', 'SPEI_SOUND_END', 'SVSFIsXML',
    'SAFTCCITT_ALaw_22kHzMono', 'SITooFast', 'DISPID_SDKGetlongValue',
    'SAFT16kHz8BitMono', 'SAFT22kHz16BitMono', 'SPAS_RUN',
    'SpeechRuleAttributes', 'SP_VISEME_8', 'SSFMCreate',
    'DISPID_SGRSAddSpecialTransition', 'DISPID_SLPs_NewEnum',
    'SVSFIsFilename', 'DISPID_SRSSupportedLanguages',
    'SECFIgnoreKanaType', 'SAFTCCITT_uLaw_22kHzStereo',
    'ISpeechMemoryStream', 'SPEI_RESERVED2', 'ISpeechMMSysAudio',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'SVSFNLPSpeakPunc', 'SPSEMANTICFORMAT', 'SPFILEMODE',
    'DISPID_SDKEnumValues', 'SECFDefault', 'SVP_16',
    'DISPID_SRGDictationSetState', 'eLEXTYPE_PRIVATE5',
    'DISPID_SRGCmdLoadFromFile', 'DISPID_SPIAudioSizeTime',
    'ISpPhrase', 'SGDSActive', 'SVP_18', 'ISpStream',
    'DISPID_SRGSetWordSequenceData', 'SAFT48kHz8BitMono',
    'eLEXTYPE_PRIVATE18', 'DISPID_SDKGetBinaryValue', 'STSF_AppData',
    'DISPID_SRSAudioStatus', 'SPEI_TTS_BOOKMARK', 'SVP_12',
    'DISPID_SLGetGenerationChange',
    'DISPID_SpeechGrammarRuleStateTransitions',
    'DISPID_SWFEBlockAlign', 'DISPID_SVSyncronousSpeakTimeout',
    'DISPID_SGRSTsItem', 'DISPID_SLPType', 'DISPID_SPPName',
    'DISPID_SpeechPhraseProperties', 'eLEXTYPE_RESERVED10',
    'DISPID_SRGId', 'SAFT48kHz16BitMono', 'DISPID_SpeechMMSysAudio',
    'SBOPause', 'SWTDeleted', 'SREPrivate', 'SpeechRecoContextState',
    'DISPID_SPELexicalForm', 'ISpNotifySink', 'ISpeechWaveFormatEx',
    'eWORDTYPE_ADDED', 'SPINTERFERENCE_TOOQUIET', 'SPVISEMES',
    'DISPID_SVSInputSentenceLength', 'SpCustomStream', 'SITooSlow',
    'SGDSActiveUserDelimited', 'DISPID_SWFESamplesPerSec',
    'SpeechTokenValueCLSID', 'SVP_4', 'DISPID_SPAPhraseInfo',
    'DISPID_SGRSTransitions', 'SpeechCategoryRecoProfiles',
    'SPSUnknown', 'SPSHORTCUTPAIRLIST', 'SPEI_PHONEME',
    'DISPID_SDKSetBinaryValue', 'DISPID_SLGenerationId',
    'DISPID_SVEPhoneme', 'DISPID_SVGetAudioInputs',
    'DISPID_SPIEnginePrivateData',
    'DISPID_SPANumberOfElementsInResult', 'SDKLCurrentUser',
    'SPRECOGNIZERSTATUS', 'SPEI_RESERVED5', 'ISpeechRecognizerStatus',
    'DISPID_SLWLangId', 'ISpRecognizer', 'DISPID_SGRAttributes',
    'ISpeechGrammarRuleStateTransition', 'SPVPRIORITY',
    'SPXMLRESULTOPTIONS', 'SPWP_UNKNOWN_WORD_PRONOUNCEABLE',
    'SPRST_ACTIVE_ALWAYS', 'SPRS_INACTIVE', 'DISPID_SGRsCount',
    'DISPID_SLRemovePronunciation', 'eLEXTYPE_PRIVATE13',
    'SAFT22kHz8BitMono', 'ISpeechPhoneConverter',
    'ISpeechLexiconPronunciations', 'STSF_CommonAppData',
    'SPWORDLIST', 'SAFTADPCM_8kHzMono', '_SPAUDIOSTATE',
    'SpeechGrammarWordType', 'DISPID_SWFEBitsPerSample',
    'SPEI_SOUND_START', 'SPEI_SR_PRIVATE', 'SAFTADPCM_8kHzStereo',
    'DISPID_SpeechDataKey', 'DISPID_SMSAMMHandle',
    'SAFT44kHz16BitStereo', 'ISpeechPhraseAlternates',
    'SpeechPropertyNormalConfidenceThreshold', 'SPEI_START_SR_STREAM',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'DISPID_SLWsItem',
    'DISPID_SRGCmdSetRuleIdState', 'DISPID_SRRTStreamTime',
    'DISPID_SVAlertBoundary', 'SpInprocRecognizer',
    'SpeechVisemeType', 'SVSFIsNotXML', 'SINone', 'DISPID_SOTsItem',
    'SRERequestUI', 'DISPID_SRDisplayUI', 'ISpEventSink',
    'DISPID_SVEventInterests', 'SAFTADPCM_22kHzMono',
    'ISpSerializeState', 'DISPID_SPIElements',
    'SpeechEngineProperties', 'DISPID_SPEDisplayText',
    'DISPID_SPPNumberOfElements', 'SPPS_RESERVED4', 'SPVPRI_OVER',
    'ISpeechRecoResultTimes', 'SpeechDataKeyLocation',
    'DISPID_SOTDataKey', 'DISPID_SRRDiscardResultInfo',
    'SAFT22kHz8BitStereo', 'eLEXTYPE_USER_SHORTCUT',
    'SREPropertyStringChange', 'SPRULE', 'ISequentialStream',
    'DISPID_SpeechObjectTokenCategory', 'ISpShortcut', 'ISpAudio',
    'SPWF_INPUT', 'DISPID_SpeechPhraseReplacements',
    'eLEXTYPE_RESERVED6', 'DISPID_SPRsItem', 'SPAR_Medium',
    'DISPID_SVESentenceBoundary', 'DISPID_SPRuleParent',
    'DISPID_SpeechRecoResult2', 'SpeechSpecialTransitionType',
    'SpeechAllElements', 'SPEI_START_INPUT_STREAM', 'SPPHRASERULE',
    'SPINTERFERENCE', 'SVSFParseAutodetect',
    'ISpeechPhraseInfoBuilder', 'DISPID_SpeechRecoResult',
    'SPSEMANTICERRORINFO', 'SINoSignal', 'DISPID_SDKSetLongValue',
    'SpNotifyTranslator', 'SVP_3', 'SPPS_RESERVED1', 'SRESoundEnd',
    'DISPID_SMSALineId', 'SRAORetainAudio', 'DISPID_SGRName',
    'DISPID_SRRAudio', 'DISPID_SRGReset',
    'DISPID_SpeechPhraseElements', 'SVP_15',
    'SpeechGrammarTagUnlimitedDictation', 'ISpRecoCategory', 'SVP_8',
    'SPRST_INACTIVE_WITH_PURGE', 'SVP_10', 'SpeechPartOfSpeech',
    'SPINTERFERENCE_LATENCY_WARNING',
    'DISPID_SOTRemoveStorageFileName', 'SpeechVoiceSpeakFlags',
    'SpeechLoadOption', 'eLEXTYPE_USER', 'DISPID_SGRSTPropertyValue',
    'SAFTADPCM_11kHzMono', 'SpeechRegistryLocalMachineRoot',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'SPGS_ENABLED',
    'ISpeechPhraseElement', 'SPGS_DISABLED', 'eLEXTYPE_PRIVATE14',
    'eLEXTYPE_VENDORLEXICON', 'ISpeechAudioBufferInfo',
    'SGSExclusive', 'SVP_0', 'DISPID_SVSpeakCompleteEvent',
    'SPSTREAMFORMATTYPE', 'DISPID_SPEsItem',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'SPSFunction', 'SLODynamic',
    'SECHighConfidence', 'ISpNotifySource', 'ISpLexicon',
    'SP_VISEME_21', 'SPSNotOverriden', 'SPRECORESULTTIMES',
    'DISPID_SRRTTickCount', 'SPSHORTCUTPAIR', 'UINT_PTR',
    'DISPID_SGRClear', 'DISPID_SPPsItem', 'DISPID_SRGState',
    'SRSActiveAlways', 'DISPID_SPARecoResult',
    'SAFTTrueSpeech_8kHz1BitMono', 'DISPID_SRCEEndStream', 'SpVoice',
    'SPBINARYGRAMMAR', 'SVSFParseMask', 'DISPID_SGRAddState',
    'SPPHRASEELEMENT', 'ISpeechGrammarRule', 'DISPID_SLPsCount',
    'DISPID_SPIAudioStreamPosition', 'ISpeechGrammarRuleState',
    'SAFTADPCM_11kHzStereo', 'SPRS_ACTIVE', 'SPPS_Noncontent',
    'DISPID_SRGCmdLoadFromObject', 'eLEXTYPE_RESERVED7',
    'eLEXTYPE_PRIVATE4', 'SpeechRunState', 'SPEI_MIN_TTS',
    'SPCS_DISABLED', 'SpeechUserTraining', 'DISPID_SpeechRecognizer',
    'DISPID_SRCEventInterests', 'SpPhoneticAlphabetConverter',
    'SPSHT_OTHER', 'SGRSTTWildcard', 'DISPID_SPRFirstElement',
    'SpSharedRecognizer', 'DISPID_SOTGetStorageFileName', 'SpLexicon',
    'IEnumString', 'DISPID_SPEAudioTimeOffset', 'SVP_7',
    'SREBookmark', 'DISPID_SVSInputSentencePosition',
    'DISPID_SRAudioInputStream', 'ISpDataKey', 'eLEXTYPE_PRIVATE2',
    'ISpeechPhraseInfo', 'SVEStartInputStream', 'SAFT32kHz16BitMono',
    'SAFTDefault', 'eLEXTYPE_PRIVATE9', 'DISPID_SpeechPhraseProperty',
    'DISPID_SPPs_NewEnum', 'SAFT11kHz16BitStereo',
    'DISPID_SPIGetDisplayAttributes', 'SAFTCCITT_ALaw_11kHzMono',
    'SRAONone', 'eLEXTYPE_APP', 'SPCT_SUB_COMMAND',
    'SPCT_SUB_DICTATION', 'DISPID_SPAsItem', 'SGRSTTTextBuffer',
    'DISPID_SOTCGetDataKey', 'SPINTERFERENCE_TOOSLOW',
    'SPPHRASEPROPERTY', 'DISPID_SGRsDynamic', 'SpResourceManager',
    'DISPID_SRCCmdMaxAlternates', 'SAFT24kHz16BitStereo',
    'DISPID_SAVolume', 'SAFT8kHz16BitMono', 'SREInterference',
    'DISPIDSPTSI', 'DISPID_SLRemovePronunciationByPhoneIds',
    'SECFIgnoreCase', 'DISPID_SVSpeakStream',
    'DISPID_SPERequiredConfidence', 'DISPID_SABIEventBias',
    'SpeechFormatType', 'SpeechAudioState', 'SP_VISEME_18',
    'SPVPRI_ALERT', 'SGRSTTDictation', 'SpeechStreamSeekPositionType',
    'SAFT44kHz8BitMono', 'SpeechRecoEvents', 'SPSInterjection',
    'SVP_14', 'SPSHORTCUTTYPE', 'DISPID_SPCLangId',
    'SPSMF_SAPI_PROPERTIES', 'SpObjectToken',
    'DISPID_SRCEEnginePrivate', 'DISPID_SGRsAdd',
    'SpeechRetainedAudioOptions', 'SPPS_Function',
    'DISPID_SpeechVoice', 'DISPID_SRRAlternates',
    'SPEI_PROPERTY_NUM_CHANGE', 'DISPID_SRAudioInput',
    'SDKLLocalMachine', 'SPEI_SR_BOOKMARK', 'SRAExport',
    'DISPID_SpeechGrammarRule', 'SpeechStreamFileMode',
    'SpeechVisemeFeature', 'DISPID_SLPLangId', 'SPDKL_LocalMachine',
    'SpeechGrammarTagWildcard', 'SVSFParseSapi', 'SVEBookmark',
    'SPAO_NONE', 'SPSMF_UPS', 'SpeechDiscardType', 'DISPID_SOTCId',
    'ISpeechRecoContext', 'SRCS_Disabled', 'SpeechGrammarState',
    'SPINTERFERENCE_TOOFAST', 'DISPID_SVGetVoices', 'SGDisplay',
    'DISPID_SPAs_NewEnum', 'DISPID_SVEWord', 'SREPropertyNumChange',
    'SAFT12kHz16BitMono', 'SVP_1', 'SVP_19', 'SPLO_STATIC',
    'SPRST_NUM_STATES', 'DISPID_SRCRecognizer',
    'DISPID_SGRInitialState', 'DISPIDSPTSI_SelectionLength',
    'DISPID_SPRText', 'DISPID_SpeechPhraseAlternates',
    'SpeechTokenContext', 'SGLexicalNoSpecialChars',
    'eWORDTYPE_DELETED', 'SRADefaultToActive', 'SDTAudio',
    'ISpGrammarBuilder', 'DISPID_SRCBookmark', 'SDKLDefaultLocation',
    'SDA_Consume_Leading_Spaces', 'ISpeechPhraseAlternate',
    'SECFEmulateResult', 'DISPID_SRGCmdSetRuleState', 'SP_VISEME_17',
    'SVPNormal', 'SPFM_OPEN_READWRITE', 'SP_VISEME_13',
    'DISPID_SDKOpenKey', 'SpFileStream',
    'DISPID_SPEAudioStreamOffset', 'DISPID_SPCIdToPhone',
    'DISPID_SDKDeleteValue', 'DISPID_SpeechLexiconWord',
    'SpeechPropertyComplexResponseSpeed', 'DISPID_SBSWrite',
    'SGRSTTEpsilon', 'SPRS_ACTIVE_USER_DELIMITED',
    'DISPID_SRRecognizer', 'DISPID_SLGetWords',
    'SpObjectTokenCategory', 'SPAUDIOSTATUS',
    ...
    'SAFTGSM610_44kHzMono', 'SPDKL_DefaultLocation', 'SDTAlternates',
    'SDA_Two_Trailing_Spaces', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'DISPID_SOTDisplayUI', 'ISpeechAudioFormat',
    'DISPID_SLAddPronunciation', 'DISPID_SGRsItem',
    'ISpPhoneticAlphabetConverter', 'DISPID_SPEActualConfidence',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'DISPID_SPCPhoneToId',
    'DISPID_SRCERecognition', 'SPPS_Modifier',
    'eLEXTYPE_LETTERTOSOUND', 'SpStreamFormatConverter',
    'SPPHRASEREPLACEMENT', 'SAFT24kHz8BitMono', 'DISPID_SGRSTsCount',
    'DISPID_SpeechXMLRecoResult', 'SPWAVEFORMATTYPE', 'SP_VISEME_16',
    'ISpeechPhraseReplacements', 'DISPID_SWFEExtraData',
    'SAFTGSM610_11kHzMono', 'SPPS_LMA', 'ISpRecognizer3',
    'SpeechWordPronounceable',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'ISpRecoGrammar',
    'SREHypothesis', 'DISPID_SRRTLength', 'SAFT8kHz8BitMono',
    'DISPID_SPERetainedSizeBytes', 'DISPID_SLWType', 'SVP_2',
    'DISPID_SpeechLexiconPronunciation',
    'DISPID_SRCERecognitionForOtherContext',
    'SAFTCCITT_uLaw_44kHzMono', 'DISPID_SpeechPhraseReplacement',
    'DISPID_SRCAudioInInterferenceStatus', 'ISpProperties',
    'DISPID_SpeechPhraseRules', 'eLEXTYPE_PRIVATE8',
    'DISPID_SpeechRecoContextEvents', 'DISPIDSPTSI_SelectionOffset',
    'SpeechCategoryAudioIn', 'SpeechInterference', 'SVEAllEvents',
    'SPRECOSTATE', 'DISPID_SDKGetStringValue',
    'ISpeechPhraseProperty', 'SRSInactiveWithPurge',
    'DISPID_SVSVisemeId', 'ISpeechLexicon', 'IEnumSpObjectTokens',
    'SPEI_RESERVED1', 'DISPID_SRGDictationLoad',
    'SpeechAudioFormatGUIDWave', 'DISPID_SLPSymbolic',
    'SDTPronunciation', 'ISpeechPhraseRule',
    'SGDSActiveWithAutoPause', 'DISPID_SVRate',
    'DISPID_SRCEPhraseStart', 'DISPID_SLPPhoneIds',
    'DISPID_SOTGetAttribute', 'SITooQuiet', 'ISpRecoResult',
    'SAFT24kHz16BitMono', 'SPLO_DYNAMIC', 'SPEI_MIN_SR',
    'SDA_One_Trailing_Space', 'DISPID_SGRSTPropertyName',
    'SVSFPurgeBeforeSpeak', 'SVP_20', 'SpeechCategoryPhoneConverters',
    'IInternetSecurityMgrSite', 'DISPID_SLPPartOfSpeech',
    'SpeechPropertyResponseSpeed', 'SpeechTokenIdUserLexicon',
    'SRADynamic', 'SpMMAudioOut', 'SPAR_High', 'DISPID_SVSpeak',
    'DISPID_SVDisplayUI', 'DISPID_SVGetProfiles', 'SPEI_RESERVED3',
    'SRARoot', 'SPAUDIOSTATE', 'eLEXTYPE_RESERVED4', 'ISpRecoContext',
    'SpeechRecoProfileProperties', 'DISPID_SVGetAudioOutputs',
    'SPCT_DICTATION', 'DISPID_SRCVoice', 'SASStop',
    'ISpeechRecoResultDispatch', 'SAFTCCITT_uLaw_44kHzStereo',
    'DISPID_SRGDictationUnload', 'SpCompressedLexicon',
    'DISPID_SpeechPhraseElement', 'SPAS_STOP', 'SP_VISEME_19',
    'SP_VISEME_10', 'DISPID_SGRSTPropertyId',
    'SAFTCCITT_ALaw_8kHzMono', 'DISPID_SPRuleNumberOfElements',
    'DISPID_SGRSTType', 'SpeechBookmarkOptions', 'DISPID_SBSSeek',
    'SVF_None', 'DISPIDSPTSI_ActiveLength',
    'ISpeechPhraseReplacement', 'SECLowConfidence',
    ...
    'SLOStatic', 'SPGRAMMARSTATE', 'DISPID_SGRSAddWordTransition',
    'SAFT48kHz8BitStereo', 'eLEXTYPE_PRIVATE1', 'SPEI_REQUEST_UI',
    'ISpMMSysAudio', 'SPAR_Unknown', 'SVP_21',
    'DISPID_SpeechCustomStream', 'eLEXTYPE_PRIVATE20',
    'eLEXTYPE_PRIVATE11', 'ISpStreamFormatConverter',
    'SpeechAudioFormatGUIDText', 'eLEXTYPE_PRIVATE6',
    'DISPID_SRSCurrentStreamNumber', 'DISPID_SPEPronunciation',
    'SGSEnabled', 'ISpeechRecoResult', 'DISPID_SVEViseme',
    'ISpeechGrammarRules', 'SpeechVoiceSkipTypeSentence',
    'DISPID_SCSBaseStream', 'SP_VISEME_1', 'eLEXTYPE_PRIVATE15',
    'SPINTERFERENCE_NOISE', 'DISPID_SRRTOffsetFromStart',
    'DISPID_SVSLastResult', 'DISPID_SOTCSetId', 'DISPID_SLWWord',
    'eLEXTYPE_PRIVATE10', 'SpeechAudioFormatType',
    'SPDKL_CurrentUser', 'DISPID_SPRs_NewEnum', 'DISPID_SOTId',
    'SAFTCCITT_uLaw_22kHzMono', 'DISPID_SPRuleId',
    'DISPID_SDKEnumKeys', 'SPRULESTATE',
    'SWPUnknownWordPronounceable', 'DISPID_SRCRetainedAudioFormat',
    'ISpeechRecoResult2', 'SRATopLevel', 'SpeechRecognitionType',
    'SAFTCCITT_uLaw_8kHzStereo', 'SRTStandard', 'SpPhraseInfoBuilder',
    'DISPID_SPIGrammarId', 'SAFT12kHz8BitStereo', 'DISPID_SOTRemove',
    'SGSDisabled', 'DISPID_SRRSaveToMemory', 'tagSPPROPERTYINFO',
    'DISPID_SABIBufferSize', '__MIDL_IWinTypes_0009',
    'DISPID_SPPChildren', 'ISpRecognizer2', 'DISPID_SLWsCount',
    'SP_VISEME_2', 'SRAImport', 'SAFT12kHz8BitMono',
    'DISPID_SOTCategory', 'DISPID_SpeechPhraseInfo', 'SFTSREngine',
    'DISPID_SRRSpeakAudio', 'DISPID_SVVolume', 'SP_VISEME_14',
    'SGPronounciation', 'SpeechTokenShellFolder',
    'SpTextSelectionInformation', 'SpeechCategoryVoices',
    'eLEXTYPE_RESERVED9', 'eLEXTYPE_PRIVATE12',
    'SpeechEngineConfidence', 'DISPID_SRCPause', 'ISpeechBaseStream',
    'DISPID_SRCESoundStart', 'DISPID_SpeechAudioBufferInfo',
    'SVEPhoneme', 'SPEI_VOICE_CHANGE', 'ISpeechResourceLoader',
    'SVSFDefault', 'SPEI_UNDEFINED', 'SVP_11', 'ISpeechAudio',
    'SVSFNLPMask', 'SPPARTOFSPEECH', 'SRSEIsSpeaking',
    'SPADAPTATIONRELEVANCE', 'SpUnCompressedLexicon', 'SRTReSent',
    'DISPID_SVSkip', 'SPRECOCONTEXTSTATUS', 'IStream',
    'DISPID_SVSRunningState', 'SpMMAudioIn', 'SPEI_RECO_STATE_CHANGE',
    'DISPID_SpeechAudio', 'Speech_Max_Word_Length',
    'Speech_Max_Pron_Length', 'DISPID_SGRSTs_NewEnum',
    'SpeechRecognizerState', 'STSF_FlagCreate',
    'DISPID_SOTMatchesAttributes', 'SREPhraseStart',
    'DISPID_SVStatus', 'SP_VISEME_5', 'SPINTERFERENCE_NOSIGNAL',
    'SBONone', 'DISPID_SGRSTRule', 'DISPID_SRRPhraseInfo',
    'SpeechTokenKeyFiles', 'SVSFParseSsml', 'SPEI_ADAPTATION',
    'SSTTTextBuffer', 'DISPID_SVSCurrentStreamNumber', 'SPXRO_SML',
    '_ISpeechRecoContextEvents', 'SPBOOKMARKOPTIONS',
    'SSFMOpenForRead', 'DISPID_SABIMinNotification',
    'DISPID_SABufferNotifySize', 'DISPID_SVEAudioLevel',
    'DISPID_SASNonBlockingIO', 'eLEXTYPE_PRIVATE3', 'SPBO_TIME_UNITS',
    'SRTEmulated', 'SPWORDPRONOUNCEABLE', 'ISpeechVoiceStatus',
    'SPFM_CREATE_ALWAYS', 'DISPID_SLWs_NewEnum', 'SASRun',
    'DISPID_SpeechWaveFormatEx', 'ISpObjectTokenCategory',
    'DISPID_SpeechLexicon', 'SpeechPropertyAdaptationOn',
    'DISPID_SGRAddResource', 'DISPID_SRCEBookmark',
    'DISPID_SPERetainedStreamOffset', 'SVSFUnusedFlags',
    'SpInProcRecoContext', 'SRTAutopause', 'SpeechLexiconType',
    'SPEI_SR_AUDIO_LEVEL', 'SVP_9', 'ISpObjectWithToken',
    'SpNullPhoneConverter', 'SDTAll', 'SAFTCCITT_ALaw_44kHzMono',
    'ISpResourceManager', 'DISPID_SVEBookmark', 'SPTEXTSELECTIONINFO',
    'SPBO_AHEAD', 'SpeechPropertyHighConfidenceThreshold',
    'SPEI_MAX_TTS', 'SPSERIALIZEDPHRASE', 'SPFM_CREATE',
    'DISPID_SPRulesItem', 'DISPID_SVEStreamEnd', 'DISPID_SBSFormat',
    'DISPID_SRSNumberOfActiveRules', 'SpeechWordType',
    'DISPID_SPAStartElementInResult', 'SRTExtendableParse',
    'DISPID_SRSetPropertyNumber', 'SVSFPersistXML',
    'DISPID_SGRsCommitAndSave', 'SPLOADOPTIONS', 'SSTTDictation',
    'DISPID_SpeechLexiconProns', 'SLTUser', 'DISPID_SFSOpen',
    'ISpVoice', 'SpeechAudioVolume', 'SPPS_SuppressWord',
    'DISPID_SMSSetData', 'SAFT16kHz16BitMono', 'SDTLexicalForm',
    'SINoise', 'DISPID_SpeechObjectTokens', 'SPAO_RETAIN_AUDIO',
    'DISPID_SOTCreateInstance', 'SpMMAudioEnum', 'eLEXTYPE_PRIVATE16',
    'SAFT44kHz16BitMono', 'SWPUnknownWordUnpronounceable',
    'ISpRecoContext2', 'DISPID_SASCurrentDevicePosition',
    'SPEI_RECOGNITION', 'SpSharedRecoContext', 'ISpeechLexiconWords',
    'DISPID_SRGetPropertyNumber', 'SP_VISEME_12', 'STCAll',
    'SPEI_WORD_BOUNDARY', 'DISPID_SDKCreateKey', 'DISPID_SPEsCount',
    'ISpObjectToken', 'DISPID_SpeechRecoContext',
    'SAFTNonStandardFormat', 'DISPID_SVSLastStreamNumberQueued',
    'SVEEndInputStream', 'ISpeechDataKey', 'ISpeechObjectToken',
    'SPEI_RECO_OTHER_CONTEXT', 'SAFT12kHz16BitStereo',
    'eLEXTYPE_PRIVATE7', 'SPWORDTYPE', 'SpeechPropertyResourceUsage',
    'SPEI_FALSE_RECOGNITION', 'DISPID_SpeechAudioStatus',
    'SpWaveFormatEx', 'DISPID_SPPFirstElement',
    'SpeechGrammarTagDictation',
    'DISPID_SRGCmdLoadFromProprietaryGrammar',
    'DISPID_SADefaultFormat', 'SpeechCategoryAudioOut',
    'DISPID_SRCESoundEnd', 'SPSERIALIZEDRESULT',
    'DISPID_SDKDeleteKey', 'SGRSTTWord', 'DISPID_SGRsCommit',
    'SASClosed', 'DISPID_SWFEAvgBytesPerSec', 'STCLocalServer',
    'DISPID_SVAudioOutputStream', 'SAFTCCITT_uLaw_11kHzStereo',
    'DISPID_SVEStreamStart', 'SRSInactive', 'ISpeechXMLRecoResult',
    'SDTRule', 'DISPID_SRCSetAdaptationData', 'DISPID_SPRulesCount',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'DISPID_SRCERecognizerStateChange', 'SGDSInactive',
    'SPVOICESTATUS', 'DISPID_SPRDisplayAttributes',
    'DISPID_SPRuleName', 'SP_VISEME_9', 'SP_VISEME_20',
    'DISPID_SRIsUISupported', 'ISpeechRecognizer',
    'DISPID_SWFEFormatTag', 'SAFTCCITT_uLaw_11kHzMono',
    'DISPID_SPPEngineConfidence', 'DISPID_SPPConfidence',
    'SPXRO_Alternates_SML', 'eLEXTYPE_PRIVATE19',
    'DISPID_SpeechLexiconWords', 'SVP_5', 'DISPIDSPTSI_ActiveOffset',
    'DISPID_SVVoice', 'SAFT48kHz16BitStereo', 'SPCT_COMMAND',
    'DISPID_SRCResume', 'SPWF_SRENGINE', 'SPPHRASE',
    'ISpeechObjectTokenCategory', 'SWPKnownWordPronounceable',
    'DISPID_SMSADeviceId', 'ISpeechPhraseElements', 'SP_VISEME_7',
    'SPSMF_SRGS_SAPIPROPERTIES', 'SPWT_PRONUNCIATION',
    'SPDKL_CurrentConfig', 'eLEXTYPE_MORPHOLOGY', 'SPEVENT',
    'SAFTCCITT_ALaw_22kHzStereo', 'DISPID_SOTsCount', 'SVEPrivate',
    'DISPID_SVEVoiceChange', 'DISPID_SGRId',
    'SAFTCCITT_ALaw_8kHzStereo', 'SPEI_SENTENCE_BOUNDARY',
    'SP_VISEME_6', 'SAFT32kHz8BitMono', 'SPLEXICONTYPE',
    'DISPID_SRCRetainedAudio', 'SPCT_SLEEP',
    'DISPID_SPIAudioSizeBytes', 'DISPID_SRRRecoContext', 'SPAS_PAUSE',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'DISPID_SRProfile',
    'STSF_LocalAppData', 'SPAR_Low',
